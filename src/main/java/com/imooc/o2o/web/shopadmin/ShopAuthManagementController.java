...
public class ShopAuthManagementController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ShopAuthManagementController.class);
        ...
        if (auth != null) {
            ...
            try {
                ...
                if (se.getState() == ShopAuthMapStateEnum.SUCCESS.getState()) {
                    ...
                    logger.error("addShopAuthMap 添加授权失败");
                    return "shop/operationfail";
                }
            } catch (RuntimeException e) {
                logger.error("addShopAuthMap 添加异常");
                return "shop/operationfail";
            }
        }
