$(function () {
        ...
        $.getJSON(listUrl, function (data) {
            if (data.success) {
                ...
                dataList.map(function (item, index) {
                    tmpHtml += '<div class="row row-product-category now">'
    ...
    // 点击一次"新增"，就新增一行
    $('#new').click(function () {
        var tmpHtml = '<div class="row row-product-category temp">'
    ...
    $('#submit').click(function () {
        ...
        tmpArr.map(function (index, item) {
            var tmpObj = {};
            tmpObj.productCategoryName = $(item).find('.category').val();
            tmpObj.priority = $(item).find('.priority').val();
            if (tmpObj.productCategoryName && tmpObj.priority) {
